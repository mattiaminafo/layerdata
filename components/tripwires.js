...
export default function Tripwires() {
  ...
  return (
    <section className="w-full py-24 flex flex-col items-center bg-transparent">
      <h2 className="text-5xl font-bold text-center mb-16 font-work-sans">{t('tripwires.title')}</h2>
                ...
                {filteredTripwires.map((tripwire, index) => (
                  ...
                  >
                    <div className="card-body p-0">
                      ...
                      <div className="text-3xl font-bold font-work-sans mb-2">{tripwire.price}</div>
        ...
        <div className="flex overflow-x-auto gap-8 pb-4 scrollbar-hide">
          {filteredTripwires.map((service, idx) => (
            ...
            >
              ...
              <div className="text-2xl font-bold font-work-sans mb-2">{service.price}</div>
