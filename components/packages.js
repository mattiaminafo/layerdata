    ...
    <section className="section-padding bg-gray-50">
      <div className="container-max">
        <div className="text-center mb-12 sm:mb-14 md:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed font-work-sans">
            {t('packages.subtitle')}
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="card text-center">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 font-work-sans">
                {packageData.name}
              </h3>
              <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
                <span className="text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--primary-purple)] font-work-sans">
                  €{packageData.price}
                </span>
