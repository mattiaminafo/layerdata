    ...
    <section className="w-full py-24 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <button className="bg-black text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-black-800 transition-colors">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-6">
          {skills.slice(0, 8).map((skill, index) => (
            <div 
              key={index}
              className="px-6 py-4 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer min-w-[200px] text-center"
