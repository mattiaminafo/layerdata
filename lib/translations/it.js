      ...
      areas: [
        {
          ...
          description: "Google Tag Manager (client + server), Adobe Launch, script custom.",
          outcome: "Eventi puliti, parametri standardizzati, validazione automatica."
        },
        {
          title: "Data Integration",
          description: "Connessioni dirette con CRM, Ads, Analytics e tool interni.",
          outcome: "Database unificato e aggiornato in tempo reale."
        },
        {
          title: "Data Warehouse & Dashboard",
          description: "BigQuery, PostgreSQL, Looker Studio, Power BI.",
          outcome: "KPI unificati, insight immediati, visual chiari."
        },
        {
          title: "Consent & Compliance",
          description: "Gestione integrata del consenso (GDPR, Iubenda, Consent Mode v2).",
          outcome: "Privacy-by-design, tracciamento sicuro."
        },
        {
          title: "Alerting & Automation",
          description: "Monitoraggio automatico e notifiche su anomalie.",
          outcome: "Performance costante, zero sorprese."
        }
      ]
    },
    why: {
