export const it = {
  ...
  hero: {
    ...
    paths: {
      ...
      body: "Ogni brand ha una storia diversa. Per questo LayerData ti offre tre modalità di attivazione: stesso livello di precisione, libertà totale su come iniziare.",
      items: [
        {
          title: "Done for you",
        ...
        {
          title: "Done with you",
          description: "Costruiamo insieme lo stack ideale e lo configuriamo passo dopo passo.",
          cta: "Configura il tuo stack →",
          href: "/it/servizi#done-with-you"
        },
        {
          title: "Done by you",
    ...
    finalCta: {
      ...
      options: [
        ...
        {
          title: "Done with you",
          description: "Vuoi costruirlo insieme? Disegniamo lo stack ideale con il tuo team.",
          cta: "Co-creiamo →",
          href: "/it/servizi#done-with-you"
        },
        {
  ...
  servicesPage: {
    ...
    modes: {
      title: "Le tre modalità operative",
      ...
      items: [
        ...
        {
          name: "Done with you",
          description: "Collaboriamo fianco a fianco: scegliamo il tuo stack e configuriamo tutto insieme.",
          perfectFor: "Team interni con risorse tech/marketing.",
