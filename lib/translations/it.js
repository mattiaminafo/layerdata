export const it = {
  ...
  home: {
    ...
    system: {
      ...
      body: "LayerData è una piattaforma modulare per raccogliere, connettere e attivare dati in tempo reale. Dalla startup alla corporate, funziona sempre allo stesso modo: veloce, pulito, misurabile.",
      modules: [
        {
          name: "LayerTrack",
    ...
    proof: {
      ...
      stats: [
        { value: "<24h", label: "Deploy medio" },
        { value: "+18%", label: "ROAS medio entro 30 giorni" },
        { value: ">99%", label: "Data accuracy tra le fonti" }
      ],
      quote: {
