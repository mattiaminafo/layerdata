export const it = {
  ...
  hero: {
    ...
    description: "Un modello integrato che unisce analytics, strategia e tecnologia per comprendere, attivare e far crescere la tua audience. Dai dati alla personalizzazione, dalla strategia alla misurazione: costruiamo sistemi che generano impatto reale.",
  ...
  contactForm: {
    ...
    subtitle: "Connettiamo i tuoi dati al business, trasformandoli in valore misurabile.",
    name: "Nome *",
    email: "Email *",
    company: "Azienda",
    role: "Ruolo",
